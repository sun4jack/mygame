...
if(pingpong.pressedKeys[KEY.GAMESTART]) { // space pressed to START
  pingpong.gamestart = true;
}

if (pingpong.pressedKeys[KEY.PADDLEBLEFT]) { // arrow-up
// move the paddle B left 8 pixels
var zleft = parseInt($("#paddleB").css("left"));
$("#paddleB").css("left",zleft-8);
}
if (pingpong.pressedKeys[KEY.PADDLEBRIGHT]) { // arrow-down
...
if (pingpong.pressedKeys[KEY.PADDLEALEFT]) { // arrow-up
// move the paddle B up 5 pixels
var zleft = parseInt($("#paddleA").css("left"));
$("#paddleA").css("left",zleft-8);
}
if (pingpong.pressedKeys[KEY.PADDLEARIGHT]) { // arrow-down
// move the paddle B down 5 pixels
var zleft = parseInt($("#paddleA").css("left"));
$("#paddleA").css("left",zleft+8);
}
